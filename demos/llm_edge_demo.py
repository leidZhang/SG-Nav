...
from decision.scenegraph_utils import get_relations_from_llm
...
if __name__ == "__main__":
    ...
    for key, val in relations.items():
        lst.append(val)
    print(lst) # view the output
    assert len(lst) == len(demo_obj_pairs) / 2, "GPT provides the wrong response!"